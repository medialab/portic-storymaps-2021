...
import './LinearAlluvialComponent.scss';

const LinearAlluvialComponent = ({
  data : inputData = [],
  sumBy,
  steps,
  width=1200,
  ...
  return (
      <svg width={width} height={height} className={cx("LinearAlluvialComponent", {'has-filters': filters.length})}>
