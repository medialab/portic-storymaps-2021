...
Visualisation des ports d’attache des navires en direction de l’étranger :

<Caller id="partie-1-ports-dattache-vers-etranger" />

Visualisation des ports d’attache de tous les navires partis de la région en 1789 :

<Caller id="partie-1-ports-dattache" />

Visualisation des destinations des ports à l’étranger partis de la région en 1789 : 
