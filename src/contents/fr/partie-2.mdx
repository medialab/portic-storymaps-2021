...
<a name="t.0f6320ce23adc712cc5040ecf014facdd20d5a5b"></a><a name="t.0"></a>
...
Nos analyses ont montré que les tonnages enregistrés à Marennes semblent surestimés à 20%, et cela monte à 50% dans 10% des pires cas. Même en prenant en compte cette distorsion, le tonnage nécessaire aux exportations vers l’étranger du port de La Rochelle n’est pas le plus important dans la région. Comme nous le verrons [dans la partie 3](https://medialab.github.io/portic-storymaps-2021/fr/page/partie-3), La Rochelle n’a pas un rôle structurant dans les relations que les ports de cette région ont avec l’étranger. 
