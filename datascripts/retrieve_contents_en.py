...
GDOC_HTML_URL = 'https://docs.google.com/document/d/e/2PACX-1vSIRoAz17R5CbQYcTJeNdii57HLUSlD6DUriy1or2kh9ThpqL9WZlPBA23vpCZut8AYnub7dQQgAcSv/pub'
...
with requests.Session() as s:
  ...
  for i, part in enumerate(prepare_contents(decoded_content)):
    ...
    if i == 0:
      ...
      md_path = TARGET_BASE + 'part-' + str(i) + '.mdx'
    elif i == 5:
