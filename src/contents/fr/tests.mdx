...
### Fond de carte - test flows avec config "France"
...
### Fond de carte - config "coast from Nantes to Bordeaux"

<GeoComponent
  backgroundFilename="cartoweb_france_1789_geojson.geojson"
  dataFilename="ports_locations_data.csv"
  height={800} // @TODO à changer quand je combin erais en un seul SVG ou component custom
  label="port"
  markerColor='customs_office'
  width={1200} // j'aurais besoin de responsive
  showLabels
